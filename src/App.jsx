...
function MerchTracker({ me, onSignOut }){
  ...
  const activeCellStyle=(id,col)=> isAnchor(id,col) ? { outline:"3px solid var(--info)", outlineOffset:"-3px", boxShadow:"inset 0 0 0 3px var(--info), inset 0 0 0 9999px rgba(37,99,166,0.10)", zIndex:isFrozen(col)?45:4, position:"relative" } : {};
