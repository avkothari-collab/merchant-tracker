...
function MerchTracker({ me, onSignOut }){
  ...
  const [expOpen,setExpOpen]=useState(false); const [expMode,setExpMode]=useState("full"); const [expBuf,setExpBuf]=useState(2); const [expIncBuf,setExpIncBuf]=useState(false); const [expRelMode,setExpRelMode]=useState("detailed");
